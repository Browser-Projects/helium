...
> **Leos-Projects fork** — This is an independent fork of [Helium by imputnet](https://github.com/imputnet/helium), maintained by [Leos-Projects](https://github.com/Leos-Projects). Includes additional features: God's Eye distraction blocker with cross-profile enforcement, incognito/guest support, user allowlist with 36-hour review, re-enabled built-in password manager, SPA-aware content enforcement, and Backup & Restore for block lists.
...
- [Latest macOS release](https://github.com/Leos-Projects/helium-macos/releases/latest)
- [Latest Linux release](https://github.com/Leos-Projects/helium-linux/releases/latest)
- [Latest Windows release](https://github.com/Leos-Projects/helium-windows/releases/latest)
...
- [Helium for macOS](https://github.com/Leos-Projects/helium-macos)
- [Helium for Linux](https://github.com/Leos-Projects/helium-linux)
- [Helium for Windows](https://github.com/Leos-Projects/helium-windows)
...
[> See development docs in macOS repo](https://github.com/Leos-Projects/helium-macos/blob/main/docs/building.md#development-build-and-environment)
